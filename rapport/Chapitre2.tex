...
tableau~\ref{tab:modelesml} compare les trois modèles retenus.

\begin{table}[H]
\centering
\caption[Comparaison des modèles de prévision]{Comparaison des trois modèles de prévision retenus.}
\label{tab:modelesml}
\begin{tabularx}{\linewidth}{|p{3.2cm}|X|X|}
\hline
...
Arbre de décision & Très interprétable (règles lisibles), rapide, utile pédagogiquement. & Instable et sujet au sur-apprentissage sans élagage ; extrapolation limitée. \\ \hline
\end{tabularx}
\end{table}
