...
\textit{Power BI}. Enfin, un module de \textbf{prévision} compare deux modèles
d'apprentissage automatique (régression linéaire et forêt aléatoire) pour estimer
les valeurs financières futures.

\par La solution, entièrement \textbf{testée} (70 tests automatiques, tous
